...
public class Categoria implements Serializable { //Se importa de Serializable porque se envia informacion a la BD por medio de objetos "Categoria".
    ...
    @Column(name = "id_categoria")                        //Es opcional. Se utiliza para mapear columans de bases de datos y atributos de codigos que tienen nombres distintos.
