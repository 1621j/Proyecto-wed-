...
@Entity
@Table(name = "seccion")
public class Seccion implements Serializable { //Se importa de Serializable porque se envia informacion a la BD por medio de objetos "Seccion".
    ...
    @Column(name = "id_seccion")                        //Es opcional. Se utiliza para mapear columans de bases de datos y atributos de codigos que tienen nombres distintos.
    ...
    /*
    @OneToMany
    @JoinColumn(name="id_seccion", updatable=false)
