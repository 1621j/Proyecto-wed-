...
public class PerfumeriaController {
    ...
    @Autowired
    public PerfumeriaController(ProductoDao productodao){
        this.productodao = productodao;
    }

    @GetMapping("/listado")
    public String getPerfumes(Model model) {
        String categoriaPerfume = "Perfumeria"; 
        List<Producto> perfumes = productodao.findByCategoriaDescripcion(categoriaPerfume);
        model.addAttribute("productos",perfumes);
               
        return "/perfumeria/listado";
